...
export function Login() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (signInDemo(username.trim(), password)) {
      ...
      <div className="relative mx-auto w-full max-w-5xl px-6 lg:px-8">
        <div className="grid overflow-hidden border border-ink-line bg-white shadow-professional lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative overflow-hidden bg-ink p-8 text-white sm:p-10 lg:p-14">
            ...
            <h2 className="mb-5 font-serif text-3xl font-bold sm:text-4xl">Gestión clara y segura</h2>
            ...
            <div className="mt-12 border-t border-white/10 pt-7 text-sm text-white/50">
              Acceso temporal de demostración: <span className="font-semibold text-white/80">admin / admin</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 sm:p-10 lg:p-14">
            ...
            <h3 className="mb-2 font-serif text-3xl font-bold text-ink">Iniciar sesión</h3>
            <p className="mb-8 text-sm leading-6 text-ink-muted">Ingresa tus credenciales para continuar a la plataforma.</p>

            <label className="mb-5 block">
              <span className="mb-2 block text-sm font-medium text-ink">Usuario</span>
